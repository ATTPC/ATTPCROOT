...
AtTpcParticlesBuilder::AtTpcParticlesBuilder(const G4String& name)
   :  G4VPhysicsConstructor(name){}


AtTpcParticlesBuilder::~AtTpcParticlesBuilder(){}


void AtTpcParticlesBuilder::ConstructParticle() {
  //
