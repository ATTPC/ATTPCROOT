...
AtTpcDecaysBuilder::AtTpcDecaysBuilder(const G4String& name)
   :  G4VPhysicsConstructor(name){}


AtTpcDecaysBuilder::~AtTpcDecaysBuilder(){}


void AtTpcDecaysBuilder::ConstructParticle(){}


void AtTpcDecaysBuilder::ConstructProcess() {
  //
